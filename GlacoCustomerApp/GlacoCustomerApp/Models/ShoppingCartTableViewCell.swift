...
//    @IBOutlet var removeButton : UIButton!
    ...
    override func layoutSubviews() {
        itemName.frame = CGRect(x: 15, y:10, width: 200, height: 30)
        itemDesc.frame = CGRect(x: 210, y: 17, width: 750, height: 20)
        itemPrice.frame = CGRect(x: 1000, y: 17, width: 90, height: 20)
        removeButton.frame = CGRect(x: 1100, y: 10, width: 80, height: 30)
    }
